        ...
        <div className="actions">
          <a className="action" href={telLink}>
            <svg viewBox="0 0 24 24" className="icon">
              <path
                d="M6.6 10.2c1.2 2.4 3 4.3 5.4 5.5l1.1-1.1c.2-.2.5-.3.8-.2 1 .3 2.1.5 3.2.5.4 0 .7.3.8.6l.9 2.7c.1.3 0 .7-.2.9l-1.9 1.9c-.3.3-.8.4-1.2.3C8.1 20.8 3.2 16 2 9.5c-.1-.5 0-1 .3-1.3L4.2 6.3c.3-.3.6-.3.9-.2l2.7.9c.3.1.6.4.6.8 0 1.1.2 2.2.5 3.2.1.3 0 .6-.2.8l-1.1 1.1z"
                fill="currentColor"
              />
            </svg>
            Call
          ...
          <a className="action" href={whatsappLink} target="_blank" rel="noreferrer">
            <svg viewBox="0 0 24 24" className="icon">
              <path
                d="M20.5 3.5C18 1 14.7 0 11.1.7 6.3 1.6 2.8 5.7 2.3 10.5c-.5 4.9 2.1 9.4 6.6 11.4l-1.6 4.6 4.8-1.6c1.8.5 3.6.2 5.2-.7 4.9-2.8 7-8.9 4.9-14C22 5.9 21.4 4.7 20.5 3.5zM12 19.2c-2.9 0-5.6-1.1-7.7-3.2-1.9-1.9-3-4.6-3-7.4C1.3 4.2 6 0.7 11.1 1.4c4 .6 7.4 3.9 8 7.9.8 5.4-3.1 10-7.1 10z"
                fill="currentColor"
              />
            </svg>
            WhatsApp
          ...
          <a className="action" href={CONFIG.linkedin} target="_blank" rel="noreferrer">
            <svg viewBox="0 0 24 24" className="icon">
              <path
                d="M4.98 3.5C4.98 5 3.9 6.1 2.4 6.1S-.2 5 .78 3.5C1.8 2 3.9 1 5.38 1s-.4 0-.4 2.5zM2 8h6v12H2zM10 8h5.5v1.6h.1c.8-1.4 2.7-2.9 5.4-2.9 5.8 0 6.9 3.8 6.9 8.8V20H22v-7.8c0-1.9-.03-4.3-2.6-4.3-2.6 0-3 2-3 4.1V20h-6V8z"
                fill="currentColor"
              />
            </svg>
            LinkedIn
          ...
          <button className="action" onClick={addToContacts} title="Add to phone contacts">
            <svg viewBox="0 0 24 24" className="icon">
              <path d="M12 3v9h4l-6 6-6-6h4V3z" fill="currentColor" />
            </svg>
            Add
          </button>
        </div>
